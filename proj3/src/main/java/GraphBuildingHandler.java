...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            edge = new GraphDB.Edge(Long.parseLong(attributes.getValue("id")));
            ...
            edge.nodeRef.add(g.nodes.get(Long.parseLong(attributes.getValue("ref"))));
            ...
            String key = attributes.getValue("v");
            node.setName(key);
            g.putTrie(key, node);
        }
    }
